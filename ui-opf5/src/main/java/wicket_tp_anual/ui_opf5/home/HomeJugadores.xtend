...
//		jugador.calificar(getPartido("La canchita de Ramon (31092014 - 23)"), this.getJugador(jugador1), puntaje,
//			"Un comentario")
//	}
...
//				this.matchInfracciones(selectorInfracciones, jug.getPenalizacionesCometidas)
//		].toList
//	}
...
//		}
//		if (desde == null) {
//			return promedio <= hasta
//		}
//		if (hasta == null) {
//			return promedio >= desde
//		}
...
//		if (selector == "Con Infracciones") {
//			return cantidad > 0
//		}else{
//		if (selector == "Sin Infracciones"){
//			cantidad==0
//		} else{
//			return true
//		}
